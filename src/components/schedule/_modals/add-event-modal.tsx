...
import { EventFormData, eventSchema, Variant, Event } from "@/types/scheduler";
...
export default function AddEventModal({
  ...
  // Mapped to the app's Button variants (no "success"/"warning" in this project's Button).
  const getButtonVariant = (color: string): "default" | "destructive" | "secondary" | "outline" => {
    switch (color) {
      case "blue":
        return "default";
      case "red":
